...
@st.cache_data
def load_data():
    csv_path = "data/clustered_jobs.csv"
    keyword_path = "data/keyword_summary.csv"
    if not os.path.exists(csv_path):
        st.error(f"Data file not found at {csv_path}. Ensure 'clustered_jobs.csv' and 'keyword_summary.csv' are in the 'data' directory.")
        return None, None
...
if df is not None:
    ...
    if keyword_df is not None:
        ...
        st.warning("Keyword data not found. Ensure 'keyword_summary.csv' is in the 'data' directory.")
